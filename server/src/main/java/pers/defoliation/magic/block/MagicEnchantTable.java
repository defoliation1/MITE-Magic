...
public class MagicEnchantTable extends BlockEnchantmentTable {

    public IIcon a;
    public IIcon b;

    public MagicEnchantTable(int par1) {
        super(par1, Items.magicstoneMaterial);
            ...
            for (int var7 = par4 - 2; var7 <= par4 + 2; ++var7) {
                ...
                if (par5Random.nextInt(16) == 0) {
                    for (int var8 = par3; var8 <= par3 + 1; ++var8) {
                        if (par1World.a(var6, var8, var7) == Block.as.cF || par1World.a(var6, var8, var7) == Blocks.magicBookshelf.cF) {
